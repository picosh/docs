...
All our realtime communication happens through IRC: #pico.sh @ [libera.chat](https://libera.chat).

We are pretty friendly and an active group so please do not hesitate to come hang out with us.

Join our channel using the [libera-hosted web client](https://web.libera.chat/gamja?autojoin=#pico.sh)
